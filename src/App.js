  ...
  return(
    <section>
      <div className="add-movie-form">
        <input placeholder="Name" value={movieName} onChange={(event)=>setName(event.target.value)}/>
        <input placeholder="Poster Url" value={moviePic}  onChange={(event)=>setPoster(event.target.value)}/>
        <input placeholder="Rating" value={imdb}  onChange={(event)=>setRating(event.target.value)}/>
        <input placeholder="Summary" value={movieSummary} onChange={(event)=>setSummary(event.target.value)}/>
        <button onClick={()=>
          {
